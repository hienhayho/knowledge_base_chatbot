...
from src.database import Users, Assistants, Conversations, Messages
...
async def create_conversation(
    ...
    new_conversation = Conversations(assistant_id=assistant.id, user_id=current_user.id)
        ...
        if product["price"]:
            try:
                ...
                try:
                    ...
                    logger.error(f"Error when formatting with regex: {price}, {str(e)}")
