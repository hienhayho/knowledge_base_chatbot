...
class SystemMessage:
    def __init__(
        self, content, base_message: BaseMessage, lc_system_message: LCSystemMessage
    ):
...
class AIMessage:
    def __init__(self, content, base_message: BaseMessage, lc_ai_message: LCAIMessage):
        self.base_message = base_message
...
class HumanMessage:
    def __init__(
        self, content, base_message: BaseMessage, lc_human_message: LCHumanMessage
    ):
        self.base_message = base_message
